...
urlpatterns = [
    ...
    path('employee_dashboard/<int:emp_id>/LoanApply', views.loanApply, name='loanApply'),
    ...
    path('approval/leave/<int:leave_id>/<int:app_id>/', views.approval, name='approval_leave'),
    path('approval/loan/<int:loan_id>/<int:app_id>/', views.approval, name='approval_loan'),
